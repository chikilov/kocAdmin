...
?>
					<script type="text/javascript">
						$(document).ready(function () {
							$("#datatable1").dataTable({
								"ajax": {
									"type"   : "POST",
									"url"    : '/<?php echo ROOTPATH; ?>/index.php/admin/rank/getsurvivalranklist<?php echo $arrRequest; ?>',
					...
					<div class="page-content-wrap">
						...
						<div class="page-title">
							<h2><span class="fa fa-sort-numeric-asc"></span>&nbsp;<?php echo ($arrRequest == 'this' ? '실시간' : '지난' );?>&nbsp;랭킹 - 서바이벌 랭킹</h2>
						</div>
						<!-- END PAGE TITLE -->
						<div class="row">
