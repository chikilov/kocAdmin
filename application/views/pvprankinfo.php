...
?>
					<script type="text/javascript">
						$(document).ready(function () {
							$("#datatable1").dataTable({
								"ajax": {
									"type"   : "POST",
									"url"    : '/<?php echo ROOTPATH; ?>/index.php/admin/rank/getpvpranklist<?php echo $arrRequest; ?>',
								...
								"columns": [
									...
									{"className" : "text-center", "data" : "wincount", "searchable": false, "render" : function ( data, type, row, meta ) { return row.wincount + "승 " + row.losecount + "패";}}
								],
								"bDestroy": true,
								"oLanguage": {
					...
					<div class="page-content-wrap">
						...
						<div class="page-title">
							<h2><span class="fa fa-sort-numeric-asc"></span>&nbsp;<?php echo ($arrRequest == 'this' ? '실시간' : '지난' );?>&nbsp;랭킹 - PVP 랭킹</h2>
						</div>
						<!-- END PAGE TITLE -->
						<div class="row">
