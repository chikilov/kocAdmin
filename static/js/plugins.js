    ...
    var formElements = function(){
        ...
        var feTimepicker = function(){
            ...
            if($(".timepicker24").length > 0)
                $(".timepicker24").timepicker({format:'hh:mm:ss', minuteStep: 1, secondStep: 1,showSeconds: true,showMeridian: false});
    ...
    var templatePlugins = function(){
        ...
        var tp_date = function(){
            ...
            if($(".plugin-date").length > 0){
                ...
                var now     = new Date();
                var now_utc = new Date(now.getUTCFullYear(), now.getUTCMonth(), now.getUTCDate(),  now.getUTCHours(), now.getUTCMinutes(), now.getUTCSeconds());
                var day     = days[now_utc.getDay()];
                var date    = now_utc.getDate();
                var month   = months[now_utc.getMonth()];
                var year    = now_utc.getFullYear();

                $(".plugin-date").html(year + '-' + month + '-' + date + ' (' + day + ')');
            }
